    ...
    public class Country : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CountryE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CountryE", typeof(IIS.Eshhe_primer.Country));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CountryL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CountryL", typeof(IIS.Eshhe_primer.Country));
                }
            }
        }
    }
